...
!----------physical parameters-----------
 ...
 disk_inner_radius  =  1.D-3                                !parsec
 disk_outer_radius  =  300.0d0                              !parsec
 log_mass_central   =  4.0d0                                !solar masses
 log_mass_disk      =  10.0d0                               !solar masses
 beta               =  0.01d0
 cs                 =  9.28D-7                              !parsec/year
 accr_eff           =  0.1d0
 time_end           =  5.4D+4                               !years

 SW_ag              =  .TRUE.                               !allow growth of central object
 SW_cem             =  .TRUE.                               !consider escaped mass for gravitational acceleration

 mode_gravitation   =  4                                    !1: Kepler, 2: monopole (low order), 3: monopole (high order), 4: selfgravitation
...
!----------numerical parameters----------
 ...
 part               =  0.8d0                                !part of grid points between disk_inner_radius and disk_outer_radius
 c_cfl              =  0.1d0
 c_itw              =  0.01d0
 d_time_min         =  1.D-10
...
!----------store options-----------------
 ...
 store_by_time      =  .TRUE.                               !store after specified time or after specified number of timesteps
 time_store         =  1.D+3                                !store after this time (years)
 steps_store        =  1000                                 !store after this number of timesteps
 time_store_general =  1.D+9                                !store general results after this time (years)

 SW_store_distrib   =  .TRUE.
 SW_store_timedev   =  .FALSE.
 SW_store_general   =  .FALSE.

 filename           =  "ext_selfgrav"
