...
!----------------------------------------------------------------------------------------------------
!parameterstudy: M_BH after 10^9 years in dependence of s_out and M_disk_init using the extended disk-model
...
IF (SW_store_general) OPEN ( UNIT = 71, FILE = "results/"//TRIM(filename)//"_general.dat" )
  ...
  DO l = 1, 3
    ...
    disk_outer_radius = disk_outer_radius + 500.0d0
    END DO

    Write(71,*) ""
    Write(71,*) ""

  log_mass_disk = log_mass_disk + 1.0d0
  END DO
